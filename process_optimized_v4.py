...
class OptimizedDetectionEngine:
    ...
    def _init_keyword_sets(self):
        ...
        self.aggressive_keywords = frozenset([
            ...
            "vous êtes mauvais", "vous êtes mauvaises", "vous êtes nuls", "vous êtes nulles",
            "c'est nul", "c'est de la merde", "c'est de la merde", "c'est de la merde",
            "c'est nul", "c'est nul", "c'est nul", "c'est nul",
            
            # Insultes et agressivité
            "con", "connard", "connasse", "salop", "salope", "putain", "merde",
            "enculé", "enculée", "fils de pute", "fille de pute", "nique", "niquer",
            "ta gueule", "ferme ta gueule", "ta mère", "ta race", "ta famille",
            
            # Agressivité verbale
            "je vous emmerde", "je vous enmerde", "je vous emmerde", "je vous enmerde",
            "allez vous faire foutre", "allez vous faire foutre", "va te faire foutre",
            "va te faire enculer", "va te faire enculer", "va te faire voir",
            
            # Expressions agressives
            "je me fous de", "je me fous de", "je me fous de", "je me fous de",
            "je m'en fous", "je m'en fous", "je m'en fous", "je m'en fous",
            "je m'en tape", "je m'en tape", "je m'en tape", "je m'en tape",
            
            # Agressivité envers le service
            "votre service est nul", "votre service est mauvais", "votre service est pourri",
            "votre entreprise est nulle", "votre entreprise est mauvaise", "votre entreprise est pourrie",
            "votre équipe est nulle", "votre équipe est mauvaise", "votre équipe est pourrie",
            
            # Agressivité envers les formations
            "vos formations sont nulles", "vos formations sont mauvaises", "vos formations sont pourries",
            "vos services sont nuls", "vos services sont mauvais", "vos services sont pourris",
            
            # Agressivité générale
            "c'est de la merde", "c'est nul", "c'est pourri", "c'est de la merde",
            "c'est de la merde", "c'est de la merde", "c'est de la merde", "c'est de la merde"
        ])
...
class OptimizedRAGEngine:
    ...
    async def analyze_intent(self, message: str, session_id: str = "default") -> RAGDecision:
        ...
        # ===== PRIORITÉ 0: AGRESSIVITÉ (BLOC AGRO) - PRIORITÉ ABSOLUE =====
...
Peux-tu me préciser comment ta formation a été financée ? (CPF, OPCO, paiement direct)""",
    ...
    def _create_aggressive_decision(self) -> RAGDecision:
        """Décision pour comportement agressif (BLOC AGRO) - NOUVEAU V4"""
        return RAGDecision(
            intent_type=IntentType.AGGRESSIVE,
            search_query="comportement agressif gestion",
            search_strategy="aggressive_handling",
            context_needed=["agressivité", "gestion", "apaisement"],
            priority_level="critical",
            should_escalate=False,
            system_instructions="""CONTEXTE DÉTECTÉ: COMPORTEMENT AGRESSIF (BLOC AGRO)
