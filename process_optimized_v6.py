...
app = FastAPI(title="JAK Company RAG V6 API", version="8.0-Continuity-Fixed")
...
class OptimizedMemoryStoreV6:
    """Store de mémoire optimisé avec TTL et limites - Version 6 avec continuité améliorée"""
    ...
    def get_last_response(self, session_id: str) -> str:
        """NOUVEAU V6: Récupère la dernière réponse donnée"""
...
memory_store = OptimizedMemoryStoreV6()

# ============================================================================
# MOTEUR DE DÉTECTION OPTIMISÉ POUR SUPABASE V6
# ============================================================================

class SupabaseDrivenDetectionEngineV6:
    """Moteur de détection basé sur les blocs Supabase - Version 6 avec continuité corrigée"""
    ...
    def _init_bloc_keywords(self):
        """Initialise les mots-clés par bloc selon la logique Supabase V6"""
        self.bloc_keywords = {
    ...
    def _detect_follow_up_context(self, message_lower: str, session_id: str) -> Optional[IntentType]:
        """Détecte les messages de suivi basés sur le contexte conversationnel - AMÉLIORÉ V6"""
        ...
        # NOUVEAU V6: Si l'utilisateur répond à une question de filtrage CPF
...
@dataclass
class SupabaseRAGDecisionV6:
    """Structure de décision RAG basée sur Supabase - Version 6"""
    bloc_id: IntentType
    search_query: str
    ...
    continuity_context: Optional[str] = None  # NOUVEAU V6: Contexte de continuité

# ============================================================================
# MOTEUR RAG OPTIMISÉ POUR SUPABASE V6
# ============================================================================

class SupabaseRAGEngineV6:
    """Moteur RAG optimisé pour la logique Supabase - Version 6 avec continuité corrigée"""
    
    def __init__(self):
        self.detection_engine = SupabaseDrivenDetectionEngineV6()
    
    async def analyze_intent(self, message: str, session_id: str = "default") -> SupabaseRAGDecisionV6:
        """Analyse l'intention avec gestion du contexte conversationnel améliorée V6"""
        message_lower = message.lower()
    
        # 1. NOUVEAU V6: Vérifier d'abord le contexte conversationnel
        ...
        # Logique spéciale pour les paiements CPF avec délai - CORRIGÉ V6
    ...
    def _detect_primary_bloc(self, message_lower: str) -> IntentType:
        """Détecte le bloc principal selon la logique Supabase V6"""
    ...
    def _should_apply_payment_filtering(self, message_lower: str, session_id: str) -> bool:
        """Détermine si on doit appliquer le filtrage de paiement - CORRIGÉ V6"""
        ...
        # NOUVEAU V6: Logique de filtrage corrigée selon la logique n8n
    ...
    def _create_payment_filtering_decision(self, message: str, session_id: str) -> SupabaseRAGDecisionV6:
        """Crée une décision pour le filtrage de paiement - CORRIGÉ V6"""
        return SupabaseRAGDecisionV6(
    ...
    def _create_ambassador_decision(self, message: str, session_id: str) -> SupabaseRAGDecisionV6:
    ...
    def _create_formation_decision(self, message: str, session_id: str) -> SupabaseRAGDecisionV6:
    ...
    def _create_aggressive_decision(self, message: str, session_id: str) -> SupabaseRAGDecisionV6:
    ...
    def _create_escalade_decision(self, message: str, session_id: str) -> SupabaseRAGDecisionV6:
    ...
    def _create_default_decision(self, bloc_id: IntentType, message: str, session_id: str) -> SupabaseRAGDecisionV6:
    ...
    def _create_contextual_decision(self, bloc_id: IntentType, message: str, session_id: str) -> SupabaseRAGDecisionV6:
        """Crée une décision basée sur le contexte conversationnel - AMÉLIORÉ V6"""
...
rag_engine = SupabaseRAGEngineV6()
...
async def root():
    ...
    return {
        "message": "JAK Company RAG V6 API - Continuity Fixed",
        "version": "8.0",
        "status": "active",
        "features": [
